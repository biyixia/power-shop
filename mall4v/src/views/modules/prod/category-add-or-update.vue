...
export default {
  ...
  methods: {
    init (id) {
      ...
      this.$http({
        url: this.$http.adornUrl('/product-service/prod/category/listCategory'),
        method: 'get',
        ...
        if (this.dataForm.categoryId) {
          // 修改
          this.$http({
            url: this.$http.adornUrl(`/product-service/prod/category/info/${this.dataForm.categoryId}`),
            method: 'get',
            params: this.$http.adornParams()
          }).then(({ data }) => {
    ...
    dataFormSubmit () {
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$http({
            url: this.$http.adornUrl(`/product-service/prod/category`),
