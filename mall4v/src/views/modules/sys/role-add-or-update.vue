  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.$http({
          url: this.$http.adornUrl('/manager-service/sys/menu/table'),
          method: 'get',
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/manager-service/sys/role/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/manager-service/sys/role`),
