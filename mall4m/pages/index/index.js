...
Page({
  ...
  getIndexImgs() {
    //加载轮播图
    var params = {
      url: "/store-service/admin/indexImg/indexImgs",
      method: "GET",
      data: {},
      callBack: (res) => {
        this.setData({
  ...
  getNoticeList() {
    // 加载公告
    var params = {
      url: "/store-service/shop/notice/topNoticeList",
      method: "GET",
      data: {},
      callBack: (res) => {
        this.setData({
  ...
  getTag() {
    var params = {
      url: "/product-service/prod/prodTag/prodTagList",
      method: "GET",
      data: {},
      callBack: (res) => {
        this.setData({
  ...
  getTagProd(id, index) {
    var param = {
      url: "/search-service/prod/prodListByTagId",
      method: "GET",
      data: {
        tagId: id,
        size: 6
