...
Page({
  ...
  onLoad: function (options) {
    if (options.addrId) {
      wx.showLoading();
      var params = {
        url: "/member-service/p/address/addrInfo/" + options.addrId,
        method: "GET",
        data: {},
        callBack: res => {
          //console.log(res)
  ...
  initCityData: function (provinceId, cityId, areaId) {
    ...
    wx.showLoading();
    var params = {
      url: "/store-service/admin/area/listByPid",
      method: "GET",
      data: {
        pid: 0
      },
...
*/
  ...
  onSaveAddr: function () {
    ...
    wx.showLoading();
    var url = "/member-service/p/address/addAddr";
    var method = "POST";
    if (ths.data.addrId != 0) {
      url = "/member-service/p/address/updateAddr";
      method = "PUT";
    }
    //添加或修改地址
    var params = {
    ...
    wx.showModal({
      ...
      success(res) {
        if (res.confirm) {
          ...
          wx.showLoading();
          var params = {
            url: "/member-service/p/address/deleteAddr/" + addrId,
            method: "DELETE",
            data: {},
            callBack: function (res) {
              wx.hideLoading();
