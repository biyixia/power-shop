...
Page({
    ...
    getCollection() {
        wx.showLoading();
        var params = {
            url: "/member-service/p/collection/isCollection",
            method: "GET",
            data: {
    ...
    addOrCannelCollection() {
        ...
        var params = {
            url: "/member-service/p/collection/addOrCancel",
            method: "POST",
    ...
    getProdInfo() {
        wx.showLoading();
        var params = {
            url: "/product-service/prod/prod/prod/prodInfo",
            method: "GET",
            data: {
                prodId: this.data.prodId,
                // userType: 0
    ...
    getProdCommData() {
        http.request({
            url: "/product-service/prod/prodComm/prodComm/prodCommData",
            method: "GET",
            data: {
                prodId: this.data.prodId,
            },
    ...
    getProdCommPage(e) {
        ...
        http.request({
            url: "/product-service/prod/prodComm/prodComm/prodCommPageByProd",
            method: "GET",
            data: {
                prodId: this.data.prodId,
                size: 10,
